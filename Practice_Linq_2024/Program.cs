...
namespace Practice_Linq_2024
{
    internal class Program
    {
        ...
        static void Query1(List<FootballGame> games)
        {
            ...
            foreach (FootballGame game in selectedGames)
            {
        ...
        static void Query2(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => (g.Home_team == "Italy" || g.Away_team == "Italy") && (g.Tournament == "Friendly") && (g.Date.Year >= 2020)); // Корегуємо запит !!!
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Home_team == "France" && g.Home_score == g.Away_score && g.Date.Year == 2021 && g.Country == "France");   // Корегуємо запит !!!
        ...
        static void Query5(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "UEFA Euro qualification" && (g.City == "Kyiv" || g.City == "Kharkiv") && g.Home_score > g.Away_score);  // Корегуємо запит !!!
        ...
        static void Query6(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "FIFA World Cup").TakeLast(8).Reverse();   // Корегуємо запит !!!
        ...
        static void Query7(List<FootballGame> games)
        {
            ...
            FootballGame g = games.First(g => g.Date.Year == 2023 && ((g.Home_score > g.Away_score && g.Home_team == "Ukraine") || g.Home_score < g.Away_score && g.Away_team == "Ukraine"));   // Корегуємо запит !!!
        ...
        static void Query8(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "UEFA Euro" && g.Country == "Ukraine").Select(x => new { MatchYear = x.Date.Year, Team1 = x.Home_team, Team2 = x.Away_team, Goals = x.Home_score + x.Away_score});   // Корегуємо запит !!!
        ...
        static void Query9(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "UEFA Nations League" && g.Date.Year == 2023).Select(x => new { MatchYear = x.Date.Year, Game = x.Home_team + "-" + x.Away_team,
                Result = x.Home_score > x.Away_score ? "Win" : x.Home_score < x.Away_score ? "Loss" : "Draw"});   // Корегуємо запит !!!
        ...
        static void Query10(List<FootballGame> games)
        {
            ...
            var selectedGames = games.Where(g => g.Tournament == "Gold Cup" && g.Date.Year == 2023 && g.Date.Month == 7).Skip(4).Take(6);    // Корегуємо запит !!!
